...
learners <- list(
    ...
    lrn(
        ...
        clinical_fav=TRUE,
        seed=internal_seed,
        id="jive_clin_fav_j3_a3"
    )
)

resources = list(
    "jive_clin_fav_j1_a1"=list(
        walltime=60*60*24, ncpus=4, memory=10000, jobs_per_chunk=5
    ),
    "jive_clin_fav_j3_a1"=list(
        walltime=60*60*24, ncpus=4, memory=10000, jobs_per_chunk=5
    ),
    "jive_clin_fav_j1_a3"=list(
        walltime=60*60*24, ncpus=4, memory=10000, jobs_per_chunk=5
    ),
    "jive_clin_fav_j3_a3"=list(
        walltime=60*60*24, ncpus=4, memory=10000, jobs_per_chunk=5
    )
)
